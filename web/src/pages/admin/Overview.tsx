...
export default function Overview() {
  ...
  const stats = [
    ...
    { icon: '✓', label: t.admin.activeAgents, val: String(activeCount), color: '#10b981' },
    { icon: '⚡', label: t.admin.totalCalls, val: totalCalls.toLocaleString(), color: '#00d4ff' },
  ]

  return (
    <div className="p-8">
      <p className="text-secondary text-xs font-mono tracking-widest uppercase mb-2">// {t.admin.overview}</p>
      <h1 className="text-2xl font-black text-white mb-7">{t.admin.dashboard}</h1>
